...
- **Rincian Rekening satu bulan: 14 detik jadi 0,9 detik.** Halaman ini dulu membangun seluruh baris transaksi satu per satu di memori sebelum menjumlahkannya — untuk sebulan itu ratusan ribu baris, dan hampir seluruh waktunya habis di situ, bukan di basis datanya. Sekarang penjumlahan dikerjakan langsung oleh basis data. Angka di layar tidak berubah sedikit pun: dibuktikan membandingkan keluaran lama dan baru pada data produksi — 2.468 sel, nol beda.
- **Breakdown Bracket berhenti melambat seiring umur data.** Saldo awal sebuah rekening dulu dihitung dengan menyapu seluruh riwayat sejak hari pertama, sehingga setiap hari yang lewat menambah beban permanen — 30 hari data 0,6 detik, 82 hari 1,6 detik, dan terus naik walau tidak ada berkas baru diunggah. Sekarang saldo penutup dicari langsung lewat indeks, dan angkanya tidak lagi bergantung pada seberapa tua data. Diukur di produksi (toko terbesar, Agustus 2026, metode sama sebelum dan sesudah): halaman satu bulan 2,64 → 1,39 detik, satu hari 0,63 → 0,41 detik.
- **Rincian Biaya dan Rekonsiliasi Bonus turun ke bawah seperlima detik.** Keduanya dulu ikut memuat kolom data mentah setiap baris padahal cuma butuh beberapa kolom. Diukur di produksi: Rincian Biaya 1,27 → 0,14 detik, Rekonsiliasi Bonus 0,42 → 0,09 detik. Hasil pemasangan bonus diperiksa identik byte-per-byte pada data produksi, termasuk brand yang memakai mode agregat.
- **Perintah baru `periksa_kesehatan`** merangkum kondisi sistem dalam satu laporan: indeks yang hilang atau rusak, sisa ruang disk, laju pertumbuhan data, dan batch terakhir tiap toko — supaya masalah kapasitas terlihat sebelum jadi gangguan, bukan sesudah.
